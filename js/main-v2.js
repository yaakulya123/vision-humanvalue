...
class VisionApp {
    ...
    updateStatus(handsCount, poseDetected, facesCount) {
        ...
        document.getElementById('poseStatus').textContent = poseDetected ? 'Detected' : 'Not Detected';
        document.getElementById('faceStatus').textContent = facesCount > 0 ? `${facesCount} Face(s)` : 'Not Detected';

        document.getElementById('poseStatus').style.color = poseDetected ? '#4ade80' : '#ef4444';
        document.getElementById('faceStatus').style.color = facesCount > 0 ? '#4ade80' : '#ef4444';
    }
